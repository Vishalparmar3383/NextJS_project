...
export default function FavoritesPage() {
    ...
    const [bookToRemove, setBookToRemove] = useState<FavoriteBook | null>(null);
    ...
    const handleConfirmRemove = async () => {
        if (!bookToRemove || !("book_id" in bookToRemove)) { // Typescript safety
            setConfirmOpen(false);
            setBookToRemove(null);
            return;
        }
        const bookId = (bookToRemove as any).book_id;
        setConfirmOpen(false);
        setBookToRemove(null);
        try {
            const res = await fetch('/api/patron/wishlist', {
    ...
    const promptRemoveFromWishlist = (book: FavoriteBook) => {
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <div className="flex items-center justify-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-600 mt-2">Your personal collection of beloved reads</p>
                        </div>
                    </div>
                ...
                {loading ? (
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-12 text-center border border-slate-200">
                        ...
                        <p className="text-slate-500 text-lg mb-6">Start exploring our collection and add books to your favorites!</p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        {favorites.map((book, index) => (
                            ...
                            >
                                ...
                                <button
                                    onClick={() => promptRemoveFromWishlist(book)}
                                ...
                                <ConfirmDialog
                                    ...
                                    message={`Are you sure you want to remove "${bookToRemove?.title}" from your wishlist?`}
                                    confirmText="Remove"
                                    cancelText="Cancel"
                                    variant="danger"
                                    onConfirm={handleConfirmRemove}
                                    onCancel={() => { setConfirmOpen(false); setBookToRemove(null); }}
                                />
